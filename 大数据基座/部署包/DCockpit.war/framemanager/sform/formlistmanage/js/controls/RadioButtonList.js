    ...
    $.extend(win, {
        ...
        BuildCtrlHTML: function(name,matchExtra) {
            ...
            var dfcn = $dataFieldCn.val(),
                ...
                rd = $repeatDirection.val(),
                rc = $repeatColumns.val();
        ...
        BuildCtrlProp: function() {
            ...
            !rc ? $el.removeAttr('RepeatColumns') : (attrs['RepeatColumns'] = rc);
        ...
        InitCtrlProp: function(el, name, matchExtra) {
            ...
            var df = $el.attr('datafield'),
                ...
                rc = $el.attr('repeatColumns'),
                rd = $el.attr('repeatDirection'),
