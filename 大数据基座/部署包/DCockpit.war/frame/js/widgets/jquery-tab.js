    ...
    if (!$.fn.tabView) {
        $.fn.tabView = function(options, param) {
            if (typeof options == "string") {
                var method = $.fn.tabView.methods[options];
                if (method) {
                    return method(this, param);
                }
            }
            return this.each(function() {
                if (!$.data(this, "tabView")) {
                    $.data(this, "tabView", new TabView(this, options));
                }
            });
        };
        ...
        $.fn.tabView.methods = {
            active: function(jq, index) {
                return jq.each(function() {
                    $.data(this, "tabView").activeTabByIndex(index);
                });
            }
        };
    }
