...
(function(win) {
    ...
    var SrcBoot = {
        ...
        getThemeSkins: function(themeName) {
            return this.getThemeConfig(themeName).skins.filter(function(item){
                return item.disable ? false : true;
            });
        },

        _linkTpl: '<link rel="stylesheet${alternate}" name="${type}" data-name="${name}" ${title} href="${href}">',
