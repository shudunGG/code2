...
(function (win, $) {
    ...
    var adjustExpandedAccBdHeight = function ($accBd) {
        ...
        $accBd.attr('data-height', win_h - ACC_ITEM_HEIGHT * accNum + 'px');
    };
    ...
    var showAccBdByRowkey = function (rowkey) {
        ...
        $accBd.removeClass('hidden').stop(true).animate({
            height:$accBd.attr('data-height')
        }, 200);
