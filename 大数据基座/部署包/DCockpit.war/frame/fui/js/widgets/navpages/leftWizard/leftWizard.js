(function (win, $) {
    ...
    function activeNext() {
        $.each($wizardItems, function () {
            var $this = $(this);
            if ($this.hasClass("active") && $this.next().hasClass("done") && !$this.hasClass("has-active")) {
                $this.addClass("has-active");
            }
            if ($this.hasClass("error") && $this.next().hasClass("done") && !$this.hasClass("has-error")) {
        ...
        Util.ajax({
            ...
            success: function (data) {
                ...
                if (Util.browsers.isIE) { 
                     Util.loadJs("frame/frame/fui/js/widgets/jquery.nicescroll.min.js", function () {
