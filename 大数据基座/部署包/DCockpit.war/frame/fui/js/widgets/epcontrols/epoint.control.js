...
(function (win, $) {
    ...
    var getPathByName = function (name) {
        ...
        var url = window._rootPath !== undefined ? _rootPath + '/frame/fui/js/widgets/epcontrols/' + name + '/' + name + '.js' : '';
    ...
    Control.prototype = {
        ...
        _loadJsPromise: function (url) {
            ...
            script.src = window._rootPath !== undefined ? _rootPath + '/' + url : url;
            // append to head
            document.getElementsByTagName('head')[0].appendChild(script);
        ...
        loadCss: function (urls, target, pos) {
            ...
            for (var i = 0, l = urls.length; i < l; ++i) {
                ...
                link.href = (window.Util && Util.getRightUrl) ? Util.getRightUrl(urls[i]) : urls[i];
                // link.href = window._rootPath !== undefined ? _rootPath + '/' + urls[i] : urls[i];
        ...
        loadHtml: function (url) {
            ...
            return $.ajax({
                url: (window._rootPath !== undefined ? _rootPath + '/' + url : url),
                type: 'GET',
                async: true,
                dataType: 'HTML'
            }).done(function (data) {
