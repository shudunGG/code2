// toolbar overflow 支持
(function(win, $) {
    // Util.loadCss('./toolbaroverflow.css');
    ...
    $.extend(ToolbarOverflow.prototype, {
        ...
        initEvent: function() {
            ...
            $(window).on(
                'resize.toolbaroverflow-' + this.uid,
                Util.throttle(
                    function() {
                        that.calcLimited();
                        that.update();
        ...
        restoreToToolbar: function(currInner_w, force) {
            ...
            while ((force && $firstChild.length) || this._restorable($firstChild, currInner_w)) {
                ...
                this.$extArea.css('width', ext_w).data('width', ext_w);
        ...
        destroy: function() {
            ...
            $(window).off('resize.toolbaroverflow-' + this.uid);
