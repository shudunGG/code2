...
$.mockJSON.data.MODULE_URL = [
    '_test/pages/module_1.html', 
    '_test/pages/module_2.html', 
    '_test/pages/module_3.html',
    '_test/pages/module_4.html', 
    '_test/pages/module_5.html', 
    '_test/pages/module_6.html'
];

$.mockJSON.data.MODULE_URL_HAS_EMPTY = $.mockJSON.data.MODULE_URL.slice(0);
$.mockJSON.data.MODULE_URL_HAS_EMPTY.push('', '', '');

$.mockJSON.data.MODULE_ICON = [
    'modicon-1', 
    'modicon-2', 
    'modicon-3', 
    'modicon-4',
...
$.mockJSON.data.UUID = function() {
    var chars = $.mockJSON.data.NUMBER.concat($.mockJSON.data.LETTER_UPPER, $.mockJSON.data.LETTER_LOWER),
        uuid = [],
        i,
        radix = chars.length;
