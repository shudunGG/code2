...
Mock.mock(Util.getRightUrl(epoint.dealRestfulUrl(getDataUrl + '/getPageInfo')), function (opt) {
    ...
    var data = Mock.mock({
        "title": "网页标题", // 网页标题
        "logo": "http://localhost/F9/F9.3.3dev/src/main/webapp/frame/fui/pages/themes/breeze/images/logo.png", // 主界面logo图片地址

        // 门户配置 考虑可配置多个 使用数组形式
        "homes|1-1": [{
            "id": "home-1",
            "name": "我的首页",
            "url": "http://localhost:8090/bendikaifa/frame/orga/user/frameuserlist?isSub=1"
        }],
...
Mock.mock(Util.getRightUrl(epoint.dealRestfulUrl(getDataUrl + '/getThemes')), function (opt) {
    ...
    return [{
            "id": "grace",
            "name": "grace",
            "preview": "frame/fui/pages/themewidgets/themeselection/images/theme.png",
            "url": "frame/fui/pages/themes/grace/grace.proto.html"
        }, {
            "id": "dream",
            "name": "dream",
            "preview": "frame/fui/pages/themewidgets/themeselection/images/theme.png",
            "url": "frame/fui/pages/themes/dream/dream.proto.html"
        },
        {
            "id": "classic",
            "name": "classic",
            "preview": "frame/fui/pages/themewidgets/themeselection/images/theme.png",
            "url": "frame/fui/pages/themes/classic/classic.proto.html"
        },
        {
            "id": "imac",
            "name": "imac",
            "preview": "frame/fui/pages/themewidgets/themeselection/images/theme.png",
            "url": "frame/fui/pages/themes/imac/imac.proto.html"
        },
        {
            "id": "metro",
            "name": "metro",
            "preview": "frame/fui/pages/themewidgets/themeselection/images/theme.png",
            "url": "frame/fui/pages/themes/metro/metro.proto.html"
        },
        {
            "id": "breeze",
            "name": "breeze",
            "preview": "frame/fui/pages/themewidgets/themeselection/images/theme.png",
            "url": "frame/fui/pages/themes/breeze/breeze.proto.html"
        }
    ]
});
        ...
        if (/query=top/.test(emt)) {
            ...
            content = Mock.mock({
                "list|5-15": [{
                    ...
                    "icon": 'modicon-@integer(1,124)', // 模块图标
                    "code": "@id", // 菜单id
                    "url|1": ["./test/testcolor.html",'./test/home.html'], // 菜单url 存在url则不应再有子菜单
                    "openType|1": [ "blank", "tabsnav"],  // 打开方式 存在url时 此属性才有效
                    // 如果有items 属性 且有内容 则该菜单具有子菜单
                    "items|0-10": [{
                        "name": "@cword(3,8)",
                        "icon": 'modicon-@integer(1,124)',
                        "code": "@id",
                        "url|1": ["./test/testcolor.html",'./test/home.html'],
                        "openType|1": [ "blank", "tabsnav","tabsnav","tabsnav"],
                        "items|0-6": [{
                            "name": "@cword(3,8)",
                            "icon": 'modicon-@integer(1,124)',
                            "code": "@id",
