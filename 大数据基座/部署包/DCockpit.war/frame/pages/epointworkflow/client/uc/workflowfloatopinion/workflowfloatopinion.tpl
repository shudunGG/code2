<div id="workflowopinion_main" class="opinion">
	<div class="opinion-toggle">
		<div class="opinion-toggle-vertical">
			<span class="opinion-toggle-text">收起</span><i class="opinion-toggle-icon"></i>
		</div>
	</div>
	<div class="floatopinion-main">
	    <h2 class="head-title">
			<span>签署意见</span>
		</h2>
		<div class="floatopinion-maincontainer">
			<div class="floatopinion-container">
				<div class="floatopinion-content">
			...
			<div class="floatopiniontemplate-container">
				<div class="floatopinion-content">
