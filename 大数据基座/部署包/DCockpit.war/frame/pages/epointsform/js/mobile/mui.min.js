    ...
    n = a.Slider = a.Scroll.extend({
        ...
        _handleSlide: function(b) {
            ...
            if (b.target === c.wrapper) {
                ...
                f = d.slideNumber;
                if (c.loop && (f += 1), !c.wrapper.classList.contains("mui-segmented-control")) for (var g = 0,
                h = e.length; h > g; g++) {
                    var i = e[g];
...
function(a, b) {
    if (a.os.plus && a.os.android) {
        ...
        a.fn.pullRefresh = function(d) {
            ...
            d.down && d.down.auto ? f._pulldownLoading() : d.up && d.up.auto && f.pullupLoading(),
            f
        }
    }
} (mui, document),
function(a, b, c, d) {
    ...
    m = a.Class.extend({
        ...
        handleEvent: function(b) {
            ...
            case "drag":
                var d = b.detail;
                this.startX ? this.lastX = d.center.x: (this.startX = d.center.x, this.lastX = this.startX),
