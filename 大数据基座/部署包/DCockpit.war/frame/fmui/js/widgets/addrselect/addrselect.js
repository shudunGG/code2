...
(function (doc, Util) {
    ...
    AddrSelect.prototype = {
        ...
        show: function () {
            ...
            this.maskEle && (this.maskEle.style.display = 'block');
        },
        ...
        hide: function () {
            ...
            this.maskEle && (this.maskEle.style.display = 'none');
        },
        ...
        toggle: function () {
            ...
            if (container.style.display == 'block') {
                ...
                maskEle && (maskEle.style.display = 'none');
            } else {
                container.style.display = 'block';
                maskEle && (maskEle.style.display = 'block');
            }
        },
        ...
        _initListeners: function () {
            ...
            that._addEvent(provinceList, 'li', function () {
                var _self = this,
                    ...
                    children = cityData3[index].children[0].children || cityData3[index].children,
         ...
         */
        _makeMask: function () {
            var emMaskEle = doc.getElementById('em-mask');

            if (emMaskEle) {
                this.maskEle = emMaskEle;
            } else {
