 ...
 * @Last Modified time: 2019-01-24 16:52:57
 * @Description: '消息中心' 
 */
(function(win, $){
    var defaultConfig = {
    ...
    $.extend(MsgCenter.prototype, {
        _init: function() {
            Util.loadCss('fui/js/widgets/msgcenter/msgcenter.css', '#common-skin', 'Before', false);
            this.isShow = false;
        ...
        _initEvent: function() {
            ...
            this.$msgCenter.on('click', '.mc-hd-close', function(e) {
                ...
                e.stopPropagation();
                if(!msgSetting) {
                    Util.loadCss('fui/js/widgets/msgcenter/msgsetting/messagesetting.css', '#common-skin', 'Before', false);

                    Util.loadJs('fui/js/widgets/msgcenter/msgsetting/messagesetting.js', function() {
                ...
                if(res) {
                    if(typeof callback == 'function') {
                        ...
                        if(opt.isDetail) {
                          ...
                          // noScroll 为 true 表示不需要滚动，在单个点击忽略的时候
                          if(!noScroll) {
                        	  setTimeout(function() {_updateInfo();}, 200);
                          } else {
                        	  setTimeout(function() {that._renderMsgTip();}, 200);
                          }
                        }
        ...
        show: function() {
            ...
            /* if(that.$msg_clamp) {
                ...
                Util.loadJs('fui/js/widgets/msgcenter/clamp.min.js', function() {
