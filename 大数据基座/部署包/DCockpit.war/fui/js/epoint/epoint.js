    ...
    return {
        ...
        adjustDataGridPageSize: function () {
            var grid = mini.get('datagrid'),
                fontMode = $.cookie('_font_mode_') || 'default';
            if (grid) {
                var thead_h = this.gridInfo.thead_h[fontMode] || 37,
                    tr_h = this.gridInfo.tr_h[fontMode] || 36,
                    pager_h = grid.showPager ? (this.gridInfo.pager_h[fontMode] || 42) : 0,
                    ...
                    grid_h = win_h - toolbar_h - toolbar_h2 - condition_h,
