    ...
    EMsgList.prototype = {
        _bindEvent: function() {
            ...
            this.$content.on("click", ".emsg-ignore-icon", function(e) {
                ...
                self.onDecEmsgCount && self.onDecEmsgCount();
                $(this).remove();
