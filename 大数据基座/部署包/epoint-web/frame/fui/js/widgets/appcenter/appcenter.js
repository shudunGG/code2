...
(function (win, $) {
    ...
    $.extend(AppCenterDialog.prototype, new Util.UserEvent(), {
        ...
        _afterInstallApp: function (appId) {
            ...
            $app.fadeOut(function () {
                $app.appendTo(that.$installedAppList).show()
                    .find('.app-center-item-btn').removeClass('install').addClass('uninstall').text('卸载');
            });
            this._updateInstalledCount(1);
        ...
        _afterUninstallApp: function (appId) {
            ...
            $app.fadeOut(function () {
                $app.appendTo($aimList).show()
                    .find('.app-center-item-btn').removeClass('uninstall').addClass('install').text('安装');
            });
        ...
        _updateInstalledCount: function(increase) {
            var $num = this.$navList.find('.js-installed-count'),
                onum = parseInt($num.text(), 10) || 0,
                nnum = onum + increase;
