...
(function(miniLocal) {
	...
	// URLSearchParams IE 下不支持
	if(!window.URLSearchParams) {
		main_dev.unshift('frame/fui/js/libs/urlsearch.js');
		main_debug.unshift('frame/fui/js/libs/urlsearch.js');
		main_prod.unshift('frame/fui/js/libs/urlsearch.js');
	}
