...
window.epoint = (function(epoint) {
    ...
    var controlResources = {
        ...
        datepicker: {
            templ: '<input id="{{fieldName}}" class="mini-datepicker" format="{{format}}" showTime="{{showTime}}" bind="{{bind}}" {{#required}}required="true"{{#requiredErrorText}} requiredErrorText="{{requiredErrorText}}"{{/requiredErrorText}}{{/required}}/>',
            options: {
                format: 'yyyy-MM-dd',
                showTime: false
            }
        ...
        checkboxlist: {
            templ: '<div id="{{fieldName}}" class="mini-checkboxlist" data="{{dataData}}" bind="{{bind}}"{{#repeatLayout}} repeatLayout="{{repeatLayout}}"{{/repeatLayout}}{{#repeatDirection}} repeatDirection="{{repeatDirection}}"{{/repeatDirection}}{{#repeatItems}} repeatItems="{{repeatItems}}"{{/repeatItems}}></div>'
        },
        radiobuttonlist: {
            templ: '<div id="{{fieldName}}" class="mini-radiobuttonlist" data="{{dataData}}" bind="{{bind}}"{{#repeatLayout}} repeatLayout="{{repeatLayout}}"{{/repeatLayout}}{{#repeatDirection}} repeatDirection="{{repeatDirection}}"{{/repeatDirection}}{{#repeatItems}} repeatItems="{{repeatItems}}"{{/repeatItems}}></div>'
        },
        webuploader: {
