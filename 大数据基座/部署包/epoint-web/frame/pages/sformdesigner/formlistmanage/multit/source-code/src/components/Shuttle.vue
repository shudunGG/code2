<template>
  <span class="form-shuttle-btns">
    <el-tooltip :open-delay="200" :content="canUndo ? '撤销' : '无可撤销的操作'">
      <!-- <el-button size="mini" type="primary" class="history-btn" icon="form-icon-undo" :disabled="!canUndo" @click="undo"></el-button>
    </el-tooltip>
    <el-tooltip :open-delay="200" :content="canRedo ? '还原' : '无可还原的操作'">
      <el-button size="mini" type="primary" class="history-btn" icon="form-icon-redo" :disabled="!canRedo" @click="redo"></el-button> -->
...
.form-icon {
  ...
  &-undo {
  //   background: url('../assets/images/top/icon_prev.png') center no-repeat;
  // }
  // &-redo {
  //   background: url('../assets/images/top/icon_next.png') center no-repeat;
