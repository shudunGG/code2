<template>
  <div class="control-form-bind">
    <div class="form-control-item">
      <el-select :value="value" @change="change" size="small" :style="styleText" :clearable="!!0" placeholder="请选择关联字段" filterable>
      ...
      <!-- <el-tooltip :open-delay="500" content="新增字段">
        <el-button icon="el-icon-plus" size="small" @click="handleAddField" style="margin-left: 10px"></el-button>
      </el-tooltip> -->
    </div>
  </div>
</template>
