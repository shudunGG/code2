<template>
  <div class="col" :id="col.id" :class="getColCls(col, index, row.cols.length)" :style="colStyle" :role="col.type == 'acc-item' ? 'accordion' : ''">
    <!-- 手风琴 -->
    <div v-if="type == 'acc-item'" role="head" :title="col.props.title" :opened="col.props.opened ? 'true': 'false'"></div>
