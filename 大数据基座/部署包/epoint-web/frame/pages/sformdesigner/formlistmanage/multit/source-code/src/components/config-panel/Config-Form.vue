  ...
  <div class="config-form">
    ...
    <div class="config-block">
      ...
      <div class="form-item">
        ...
        <el-input-number class="height-set-input" v-model="height" size="small" :controls="false" :min="38" :max="2000" @change="setHeight" />
        <span class="form-control-suffix">px</span>
      </div>
    </div>
    <div class="config-block">
      ...
      <div class="form-item">
        ...
        <BorderStyleSelect v-model="borderStyle" :border-width="borderWidth" :border-color="borderColor" :disabled="!borderWidth" />
      </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      skins: [],
      isNewSkin: false,
      height: globalStyle.cellHeight || 38,
  ...
  watch: {
    globalStyle(style) {
      ...
      this.height = style.cellHeight || 38;
