            ...
            if ($this.hasClass('save')) {
                ...
                try {
                    ...
                    if (!verifyCropperImgSize(imgData)) {
                        epoint.showTips('图片过大，已经超过2M，请选择较小的图片或更小的裁剪区域', {
                            state: 'danger',
                            timeout: 3000
                        });
                        return;
