...
(function() {
    ...
    var Inner = {
        ...
        /**
         * @description 获得本地的长期回调，每一次都是一个唯一的值
         * @retrurn 返回对应的回调id
         */
...
(function() {
    ...
    /**
     * @description 专门供API内部调用的，this指针被执行了proxy对象，方便处理
     * @param {Object} options
     */
    ejs.callProxy = function(options) {
...
(function() {
    ...
    ejs.extendModule('device', [{
        ...
        runCode: function(options) {
            ...
            ejs.callProxy.call(this, options);
        }
    }, {
        namespace: "sendMsg",
        os: ['ejs'],
...
(function() {
    ...
    ejs.extendModule('navigator', [{
        ...
        runCode: function(options) {
            ...
            ejs.navigator.setRightBtn(newOptions);
        }
    }, {
...
(function() {
    ...
    ejs.extendModule('page', [{
        ...
        runCode: function(options) {
            ...
            ejs.callProxy.call(this, ejs.innerUtil.extend({
