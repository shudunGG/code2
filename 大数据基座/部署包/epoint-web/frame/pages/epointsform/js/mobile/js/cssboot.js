...
(function(exports) {
    ...
    var comdto = {
        ...
        isUseConfig: true,
        isRestFul: true,
        rootUrl: 'http://localhost:8080/epoint-web/',
        isMock: true	//是否模拟数据
    };
...
var paths = [
    // 写入每个页面必备的css文件
    '../../../js/mobile/js/mui/mui.css',
    '../../../js/mobile/js/mui/mui.extend.css',
];
...
if (typeof Config != 'undefined') {
    ...
    if (Config.isDebug) {
        ...
        // 正式模式下的，比较简单
        arr.push('../../../js/mobile/js/_dist/core.min.css');
    }
