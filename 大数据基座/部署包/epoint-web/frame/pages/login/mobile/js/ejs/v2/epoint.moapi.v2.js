...
(function(global, factory) {
    ...
    return (function(exports, isLocal) {
        ...
        ejs.oauth = {
             ...
             * @param {Function} callback 回调函数,回调token值
             */
            refreshToken: function (callback, defaultValue) {
                JSBridge.callHandler(EJS_API, 'refreshToken', {}, function (res) {
                    res = res || {};
                    callback && callback(res.result, res.msg, res);
                });
             ...
             * @param {Function} callback 回调函数,回调token值
             */
            getV7Token: function (callback, defaultValue) {
                JSBridge.callHandler(EJS_API, 'getV7Token', {}, function (res) {
                    res = res || {};
                    callback && callback(res.result, res.msg, res);
                });
