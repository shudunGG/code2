...
// break;
                    case "sort":
                        ...
                        break;
                    case "batch":
                        var panel = mini.get('batch-panel');
                        panel && panel.show();
                        break;
                }
                if(title && pageName) {
...
function MoveDown() {
	    ...
	    if (!flag) {
	        ...
	        // }, onFail);
	        // });
	        $("#WorkFlowWrapperBg").css({ width: $('.fui-content').width() - 44, height: $('.fui-content').height() - 41, marginLeft: 44, marginTop : 41 });
	        // responseText = result;
	        var NodeName = null;
