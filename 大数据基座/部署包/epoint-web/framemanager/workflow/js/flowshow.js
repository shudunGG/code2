function FlowShow() {
	...
	FlowShow.prototype.FlowChartSort = function(jsonstring) {
	    ...
	    if(typeof jsonstring == "object"){
	    	arrayList = Util.safeEval("(" + JSON.stringify(jsonstring) + ")");
	    }else{
	    	arrayList = Util.safeEval("(" + jsonstring + ")");
	    }
	...
	FlowShow.prototype.MoveRight = function(jsonStr) {
	    ...
	    if(typeof jsonStr == "object"){
	    	arrayList = Util.safeEval("(" + JSON.stringify(jsonStr) + ")");
	    }else{
	    	arrayList = Util.safeEval("(" + jsonStr + ")");
	    }
		var nodeslist = arrayList.Nodes;
