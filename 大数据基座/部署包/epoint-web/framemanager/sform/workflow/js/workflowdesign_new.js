            ...
            .contextMenu('ie5menu1', {
                bindings: {
                    "OpenEdit": function () {
                        ...
                        epoint.openDialog(title, 'framemanager/sform/workflow/design/' + pageName + '?pid='+_uid+'&mainPVActivityGuid='+MainPVActivityGuid+'&processVersionGuid='+ProcessVersionGuid, afterInsertActivity, {
        					'width' : w,
        					'height' : h
        				});
                        function afterInsertActivity() {
                            if (param && param.Added) {
                                o.id = _id;
      ...
      this.removePath = function () {
        ...
        $([_path.node, _arrow.node])
            ...
            .contextMenu('ie5menu1', {
                bindings: {
                    "OpenEdit": function () {
                    	 epoint.openDialog("变迁设置", 'framemanager/sform/workflow/design/activitytransitionframe?pid='+ _id.replace("path", "")+'&mainPVActivityGuid='+MainPVActivityGuid+'&processVersionGuid='+ProcessVersionGuid, '', {
         					'width' : 1100,
         					'height' : 800
         				});
                    },
...
//                    title = "人工活动详细信息";
            ...
            var url = 'framemanager/sform/workflow/design/' + pageName + '?MaxID='+_id +'&IconX=' + o.attr.x * 10 + '&IconY=' + o.attr.y * 10 + '&mainPVActivityGuid='+MainPVActivityGuid+'&processVersionGuid='+ProcessVersionGuid;
            if(activityType){
            ...
            $('#toolBar .clickable').click(function () {
                ...
                switch (this.id) {
                    ...
                    case "alignGrid":
                        ...
                        return;
                    //case "template":
                    //    pageName = "framemanager/sform/workflow/design/activitytempleteframe";
                    //    h = 482;
                    //    title = "人工活动配置模板";
                    //    dialogid = "Template";
                    //    break;
                    case "materail":
                    	pageName = "framemanager/sform/workflow/manage/processmaterial";
                        title = "流程材料";
                        dialogid = "ProcessMaterial";
                        break;
                    case "context":
                    	pageName = "framemanager/sform/workflow/design/contextfieldlist";
                        title = "相关数据";
                        dialogid = "ContextField";
                        break;
                    case "method":
                    	pageName = "framemanager/sform/workflow/design/methodlist";
                        title = "方法管理";
                        dialogid = "MethodList";
                        break;
//                    case "print":
...
//                        break;
                    case "sort":
                    	pageName = "framemanager/sform/workflow/design/activitylist";
                        title = "活动排序";
                        dialogid = "Activity";
                        break;
                }
...
//                        	});
                    ...
                    //    break;
                    case "materail":
                    	pageName = "epointworkflow/manage/processmaterial";
                        title = "流程材料";
                        dialogid = "ProcessMaterial";
                        break;
                    case "context":
            ...
            $("#WorkFlowWrapper").contextMenu("ie5menu", {
                ...
                bindings: {
                    "OpenActivitySort": function () {
                    	epoint.openDialog("活动排序", 'framemanager/sform/workflow/design/activitylist?processVersionGuid='+ProcessVersionGuid+'&mainPVActivityGuid='+MainPVActivityGuid, '', {
            				'width' : 1000,
            				'height' : 450
            			});
                    },
...
//            $("#WorkFlowWrapperBg").css({ width: $(this).width() - 44, height: $(this).height(), marginLeft: 44 });
            ...
            if(typeof responseText == "object"){
            	workFlow = Util.safeEval("(" + JSON.stringify(responseText) + ")");
            }else{
            	workFlow = Util.safeEval("(" + responseText + ")");
            }
