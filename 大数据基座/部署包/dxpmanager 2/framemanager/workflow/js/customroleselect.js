(function(win, $) {
	...
	win.confirm = function(value) {
		...
		if (value == 'save') {
			epoint.execute(roleConfig.roleSave, '', [ isPublic, result, JSON.parse(info.value) ],
					function(data) {
