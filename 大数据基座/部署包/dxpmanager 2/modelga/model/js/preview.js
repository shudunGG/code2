...
(function (win, _$) {
    ...
    function makePort(name, spot, output, input) {
        return $(go.Shape, "Circle", {
            ...
            new go.Binding("fromLinkable", "classify", function (val) {
                return val && val !== 'resource';
            }),
    ...
    function load() {
    	if (!rowguid)
			return;
		epoint.execute('dxpmodeldatadeveloplistaction.getContent', null, rowguid, function(res) {
