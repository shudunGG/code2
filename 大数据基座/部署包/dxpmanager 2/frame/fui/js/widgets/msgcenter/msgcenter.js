 ...
 * @Last Modified time: 2019-05-29 15:03:48
 * @Description: '消息中心' 
 */
(function(win, $){
  var defaultConfig = {
  ...
  $.extend(MsgCenter.prototype, {
      _init: function() {
          Util.loadCss('frame/fui/js/widgets/msgcenter/msgcenter.css', '#common-skin', 'Before', false);
          this.isShow = false;
      ...
      _initBaseRequest: function() {
          ...
          //updateMode释义：
          // client:表新示更新都由业务端操作,前端打开页面之后,延时3s刷
      ...
      _initEvent: function() {
          ...
          this.$msgCenter.on('click', '.mc-hd-close', function(e) {
              ...
              e.stopPropagation();
              if(!msgSetting) {
                  Util.loadCss('frame/fui/js/widgets/msgcenter/msgsetting/messagesetting.css', '#common-skin', 'Before', false);
