(function(win, $) {
    ...
    function parseNum(num){
		...
		if (num >= 10000 && num <= 999999) {
			var len = (num / (10000 * 1.0)).toFixed(2);
			result = len + "万";
		} else if (num >= 1000000 && num <= 9999999) {
			var len = (num / (1000000 * 1.0)).toFixed(2);
			result =len + "百万";
		} else if (num >= 10000000 && num <= 99999999) {
			var len =(num / (10000000 * 1.0)).toFixed(2);
			result = len + "千万";
		} else if (num >= 100000000) {
			var len = (num /(100000000 * 1.0)).toFixed(2);
			result = len + "亿";
		} else {
			result = num;
		}
