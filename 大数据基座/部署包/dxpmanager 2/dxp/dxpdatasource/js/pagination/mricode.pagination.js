...
(function (factory) {
    ...
    Page.prototype = {
        ...
        initHtml: function () {
            ...
            //init jump module
            var jumpHtml = '<span class="l">到第</span><div class="m-pagination-group l"><input data-page-btn="jump" type="text"><button data-page-btn="jump" type="button">' + this.options.jumpBtnText + '</button></div><span class="l page-last">页</span>';
