		...
		return this.each(function(){
			...
			this.funFilterEligibleFile = function(files){
				...
				for (var i = 0, file; file = files[i]; i++) {
					...
					if(file.type.indexOf('jpg') > -1 || file.type.indexOf('jpeg') > -1 || file.type.indexOf('png') > -1 || file.type.indexOf('gif') > -1 || file.type.indexOf('rar') > -1 || file.type.indexOf('officedocument') > -1 || file.type.indexOf('zip') > -1 || file.name.indexOf('.java') > -1) {
        				...
        				if(lastname.toLowerCase() != ".rar") {
        					alert('支持上传jpg、png、jpeg、gif、rar,zip、docx、xlsx、xltx、sldx、potx、ppsx、pptx、xlsb、xlsm格式文件');
							return false;
        				}
				...
				this.funSetStatusInfo(ZYFILE.funReturnNeedFiles());  // 显示统计信息
				return arrFiles;
			};
