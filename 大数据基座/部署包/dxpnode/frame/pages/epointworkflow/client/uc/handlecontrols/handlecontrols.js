			...
			for (var i = 0; i < item.length; i++) {
				...
				btn.on('click', function() {
					AjaxOperation(this.operationguid, this.transitionguid,
							this.operationtype, this.beforeact, this.click,
...
function AjaxOperation(OperationGuid, TransitionGuid, OperationType, btnbefore,
	...
	try {
		if($("#workflowopinion_content").length > 0){
			workflowopinioncontent = $("#workflowopinion_content").val();
