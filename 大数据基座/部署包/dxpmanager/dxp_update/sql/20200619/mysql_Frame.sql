...
CREATE TABLE `dxp_subassemblyforhive` (
  ...
  `hivedsid` int(5) DEFAULT NULL COMMENT 'hive数据源dsid',
  `functionname` varchar(255) DEFAULT NULL,
  `functionparams` varchar(500) DEFAULT NULL,
  `hdfsdsid` int(5) DEFAULT NULL,
  `maxLinks` int(11) DEFAULT NULL,
...
INSERT INTO dxp_subassembly_group (rowguid, groupname, typeicon, plugintype, `orderNum`) VALUES('294820e6-0668-44af-962a-f52507fc9659', '输入组件', 'images/add-icon/input.png', 'function', 100);

GO

INSERT INTO dxp_subassembly_group (rowguid, groupname, typeicon, plugintype, `orderNum`) VALUES('4c484966-49b1-4af5-8e53-3a9610b1d725', '输出组件', 'images/add-icon/output.png', 'function', 90);

GO

INSERT INTO dxp_subassembly_group (rowguid, groupname, typeicon, plugintype, `orderNum`) VALUES('5269a595-3266-4929-a9b5-86c97e1be70e', '条件组件', 'images/add-icon/flow.png', 'function', 80);

GO

INSERT INTO dxp_subassembly_group (rowguid, groupname, typeicon, plugintype, `orderNum`) VALUES('53b46ef1-ad53-4cb2-aa53-2ffa88288c78', '转换组件', 'images/add-icon/change.png', 'function', 70);

GO

INSERT INTO dxp_subassembly_group (rowguid, groupname, typeicon, plugintype, `orderNum`) VALUES('ecd6a310-c002-45aa-8bc3-8a9dbe9c3bc0', 'UDF函数', 'images/add-icon/flow.png', 'udf', 60);
