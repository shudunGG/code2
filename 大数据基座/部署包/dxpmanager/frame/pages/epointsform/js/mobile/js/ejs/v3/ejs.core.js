...
var ejs = window.ejs || (function(exports, undefined) {
    ...
    /**
     * @description 页面初始化时必须要这个config函数
    ...
    /**
     * @description 当ejs 初始化完毕，并且config验证完毕后会触发这个回调
    ...
    /**
     * @description 当ejs出现错误时，会通过这个函数回调给开发者，可以拿到里面的提示信息
...
(function(exports) {
    ...
    var innerUtil = {
        ...
        /**
         * @description 是否是合法的os，即目标os是否在当前数组中
         * @param {Array} osArray
         * @param {String} name
        ...
        /**
         * @description 如果version1大于version2，返回1，如果小于，返回-1，否则返回0。
...
(function(exports) {
    ...
    exports.globalError = {
        ...
        /**
         * @description 1003 module modify错误
         */
        ...
        /**
         * @description 1005 组件api对应的proto不存在
         */
        ...
        /**
         * @description 1006 非ejs下无法调用自定义组件API
         */
        ...
        /**
         * @description 1007 对应的event事件在该环境下不存在
         */
        ...
        /**
         * @description 2001 ready modify错误-ready回调正常只允许定义一个
         */
        ...
        /**
         * @description 2002 config modify错误-正常一个页面只允许config一次
         */
        ...
        /**
         * @description 2004 version not support
         */
        ...
        /**
         * @description 3000 原生错误(非API错误)，原生捕获到的错误都会通知J5
         */
        ERROR_TYPE_NATIVE: {
            code: 3000,
            msg: '捕获到一处原生容器错误'
        ...
        /**
         * @description 3001 原生调用h5错误  原生通过JSBridge调用h5错误，可能是参数不对
         */
...
(function(exports) {
    /**
     * @description 一个代理类，调用特定API时，经过代理可以进行统一逻辑预处理
     * @param {Object} api
     * @param {Function} callback
    ...
    /**
     * @description epointjs api内部调用时的观察函数，用来检测api调用是否合法
    ...
    Proxy.prototype.walk = function() {
        ...
        // 另外，在返回闭包前也可以进行调用前预处理的，判断API是否合法
        //          if(true) {
        //              //返回下面那个闭包即可
        //          } else {
        //              self.target.errorTips(0,'进行错误提示');
        //              //返回一个空函数
        //              return Common.noop;
        //          }
        return function() {
            ...
            if (callback) {
                ...
                // 不存在，调用默认处理，条件是-
                // 如果是在ejs环境下，而且没有实现runcode，而且ejs.callProxy存在
                if (ejs.callProxy && self.api && self.api.os.indexOf('ejs') != -1) {
                    ejs.callProxy.apply(self, args);
                }
            }
...
(function(exports) {
    ...
    /**
     * @description 获取应该api在目标target上应该执行的os环境(这个会用到默认的几个os)
