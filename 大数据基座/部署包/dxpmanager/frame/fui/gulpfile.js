...
gulp.task('encrypt', function () {
    return gulp.src('./js/epoint/encrypt.js')
...
gulp.task('frame_prod', ['comm_uglify', 'epoint_prod', 'encrypt'], function () {
    var arr = [
        'dist/common',
        'dist/encrypt',
        'dist/common.dto',
...
gulp.task('concat_common_css', function () {
    return gulp.src([
            ...
            './css/common/common.toolbar.overflow.css',
            './css/common/common.lightdialog.css',
            './css/common/common.block.css',
