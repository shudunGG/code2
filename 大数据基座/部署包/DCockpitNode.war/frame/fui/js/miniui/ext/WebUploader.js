mini.overwrite(mini.WebUploader, {
    ...
    fileSizeLimit: window.EpFrameSysParams && EpFrameSysParams['fileSizeLimit'],

    limitType: window.EpFrameSysParams && EpFrameSysParams['fileLimitType'],

    fileNameLengthLimit: window.EpFrameSysParams && EpFrameSysParams['fileNameLengthLimit'] || 225,
    ...
    getExtraAttrs: function (el) {
        ...
        mini._ParseBool(el, attrs, ["dataImport", "showDefaultUI"]);
